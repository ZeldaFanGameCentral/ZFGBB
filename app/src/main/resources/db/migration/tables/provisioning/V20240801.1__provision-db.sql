...
CREATE TABLE IF NOT EXISTS ZFGBB.BR_USER_PERMISSION (
	...
	CONSTRAINT FK_BR_USER_PERMISSION_ID_USER_ID FOREIGN KEY (USER_ID) REFERENCES ZFGBB.USER (USER_ID) MATCH FULL ON DELETE CASCADE NOT VALID,
...
CREATE INDEX IF NOT EXISTS IDX_BR_USER_PERMISSION_USER_ID ON ZFGBB.BR_USER_PERMISSION (USER_ID);
