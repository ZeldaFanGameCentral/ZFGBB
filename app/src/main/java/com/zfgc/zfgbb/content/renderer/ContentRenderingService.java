...
public class ContentRenderingService {
	...
	public ContentRenderingService(BBCodeRenderer bbCodeRenderer, MarkdownRenderer markdownRenderer,
		...
		sourceReferenceService.registerSourceBodyRenderer(
				(rawBody, contentFormat, quotingCreatedTs) -> renderContent(contentFormat, rawBody, quotingCreatedTs,
						THE_SURFACE_A_QUOTED_BODY_WAS_WRITTEN_ON, Map.of()));
	}
	...
	public String render(String source, ContentFormat format, ContentScope scope,
		...
		return renderWithTemplates(source, format, scope, Map.of(), quotingCreatedTs);
	}
	...
	public String renderWithTemplates(String source, ContentFormat format, ContentScope scope,
		...
		return outputSanitizer.sanitize(renderContent(format, source, quotingCreatedTs, scope, context));
	}
	...
	public String plainTextWithTemplates(String source, ContentFormat format, ContentScope scope,
			Map<String, String> context) {
		return visibleTextOf(renderWithTemplates(source, format, scope, context));
	}
	...
	private String renderContent(ContentFormat format, String source, OffsetDateTime quotingCreatedTs,
